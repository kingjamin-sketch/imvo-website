...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const coreRouteCandidates: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/systems`, changeFrequency: "monthly", priority: 0.9 },\n    { url: `${siteUrl}/systems/about`, changeFrequency: "monthly", priority: 0.82 },\n    { url: `${siteUrl}/systems/contact`, changeFrequency: "monthly", priority: 0.8 },
