...
const properties = [
  {
    ...
    fallback: "/chosen/casa-lumara.webp",
    details: [
      ["CARE MODE", "Routine oversight"],
      ["REPORTING", "Photos + notes"],
      ["APPROVALS", "Owner controlled"],
  ...
  },
  {
    ...
    fallback: "/chosen/aurelian-villa.webp",
    details: [
      ["CARE MODE", "Scheduled inspections"],
      ["FOLLOW-UP", "Maintenance coordinated"],
      ["OWNER VIEW", "Reports + approvals"],
      ["PRIVACY", "Private by default"],
    ],
  },
  {
    ...
    status: "OWNER AWAY",
    image: "/chosen/atria-residence.webp",
    fallback: "/chosen/casa-palma.webp",
    details: [
      ["CARE MODE", "Owner-away care"],
      ["LOCAL PRESENCE", "Kigali"],
...
const careItems = [
  {
    ...
    text: "Scheduled checks, readiness and a reliable local presence.",
    image: "/domicile/properties/property-c1.webp",
    fallback: "/chosen/casa-lumara.webp",
  },
  {
    ...
    text: "Scope, coordinate and follow through without passing the owner from person to person.",
    image: "/domicile/properties/property-estate.webp",
    fallback: "/chosen/aurelian-villa.webp",
  },
  {
    ...
    text: "Local presence when you are not in Kigali, with a clear record of what happened.",
    image: "/chosen/brick-vine.webp",
    fallback: "/chosen/casa-palma.webp",
  },
  {
    number: "04",
    title: "Property works",
    text: "Repairs and improvements with clear owner approval before action.",
    image: "/chosen/casa-forma.webp",
    fallback: "/chosen/casa-palma.webp",
  },
];
...
export default function DomicileFinal() {
  ...
  const heroScale = useSpring(
    ...
    { stiffness: 85, damping: 24 }
  );
  const heroY = useSpring(useTransform(scrollYProgress, [0, 1], [0, 54]), {
    stiffness: 85,
    damping: 24,
  });
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        "We could not send the enquiry just now. Please try again or continue on WhatsApp."
      );
    } finally {
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero} ref={heroRef}>
        ...
        >
          <SafeImage
            ...
            fallback="/chosen/aurelian-villa.webp"
            alt="Residential property under DŌMICILE care"
            priority
          />
        </motion.div>
        ...
        <div className={styles.heroInner}>
          ...
          <h1>
            <TextRoll>Your property,</TextRoll>
            <br />
            <TextRoll>handled.</TextRoll>
          </h1>
          <p>
            One dependable local point of contact for the care, maintenance and
            coordination of your property.
          </p>
          <div className={styles.heroActions}>
            <a href="#enquire">START AN ENQUIRY <span>↗</span></a>
            <a href="#care">SEE HOW CARE WORKS <span>↓</span></a>
          </div>
        </div>
        ...
        <motion.div
          ...
          animate={
            reduceMotion
              ? undefined
              : { y: [0, -8, 0], rotate: [-2.5, -1, -2.5] }
          }
          transition={{ duration: 6.2, repeat: Infinity, ease: "easeInOut" }}
        >
          <SafeImage
            src="/domicile/properties/property-c1.webp"
            fallback="/chosen/casa-lumara.webp"
            alt="Routine property care"
            sizes="240px"
          />
          <div><small>ROUTINE CARE</small><strong>Private residence</strong></div>
        </motion.div>

        <motion.div
          className={`${styles.floatCard} ${styles.floatTwo}`}
          animate={
            reduceMotion ? undefined : { y: [0, 9, 0], rotate: [3, 1.5, 3] }
          }
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
        >
          <SafeImage
            src="/chosen/casa-palma.webp"
            fallback="/chosen/atria-residence.webp"
            alt="Owner-away property care"
            sizes="210px"
          />
          <div><small>OWNER AWAY</small><strong>Local presence</strong></div>
        </motion.div>
      ...
      <section className={styles.promise}>
        <Reveal className={styles.promiseCopy}>
          <small>ONE PROPERTY. ONE RESPONSIBLE CONTACT.</small>
          <h2>Someone local is actually following through.</h2>
          <p>
            DŌMICILE handles the coordination behind the scenes while you stay
            informed, approve what matters and keep a clear record of the property.
          </p>
        ...
        <Reveal className={styles.promisePhoto}>
          <SafeImage
            src="/domicile/properties/property-c1.webp"
            fallback="/chosen/casa-lumara.webp"
            alt="Private residence under DŌMICILE care"
            sizes="(max-width:900px) 100vw, 54vw"
          />
          <div className={styles.photoStatus}>
            <small>PRIVATE RESIDENCE</small>
            <strong>Routine care active</strong>
          </div>
          <blockquote>
            “You should not need six conversations to know what happened at your
            own property.”
          </blockquote>
        </Reveal>
      </section>
      ...
      <section className={styles.careScene} id="care">
        <div className={styles.careIntro}>
          ...
          <p>
            Each layer stays connected to the same property record and the same
        ...
        <div className={styles.careRail}>
          {careItems.map((item, index) => (
            ...
            >
              ...
              />
              <div className={styles.careShade} />
              <span>{item.number}</span>
              <h3><TextRoll>{item.title}</TextRoll></h3>
              <p>{item.text}</p>
            </motion.article>
          ))}
        </div>
      ...
      <section className={styles.ownerView} id="owner-view">
        <div className={styles.ownerBackdrop}>
          <SafeImage
            src="/domicile/properties/property-estate.webp"
            fallback="/chosen/aurelian-villa.webp"
            alt="Residential property under DŌMICILE care"
        ...
        <Reveal className={styles.ownerHeadline}>
          <small>YOUR PROPERTY, AT A GLANCE</small>
        ...
        <Reveal className={styles.dashboard}>
          ...
          <div className={styles.tabs}>
            {["Overview", "Photos", "Reports", "Approvals", "Maintenance"].map(
              (tab) => (
                <button
                  key={tab}
                  type="button"
          ...
          <div className={styles.tabBody}>
            ...
            <h3>
              {activeTab === "Overview"
                ...
                : `${activeTab} stay attached to the property record.`}
            </h3>
            <p>
              Photos, notes, approvals and completed matters remain visible without
      ...
      <section className={styles.properties} id="properties">
        <div className={styles.propertiesHead}>
          <small>SELECTED PROPERTIES UNDER CARE</small>
      ...
      <section className={styles.trustFaq} id="faq">
        <div className={styles.imvoBlock}>
          <small>BACKED BY IMVO GROUP</small>
        ...
        <div className={styles.faqBlock}>
          ...
          <div className={styles.faqList}>
            {faqItems.map(([q, a], index) => (
              <article key={q} className={openFaq === index ? styles.faqOpen : ""}>
                <button
                  type="button"
      ...
      <section className={styles.enquiry} id="enquire">
        <div className={styles.enquiryIntro}>
          <Image
            ...
            unoptimized
          />
          <small>START WITH A CONVERSATION</small>
          <h2>Tell us about your property.</h2>
          <p>
            This is an enquiry, not a registration. We will contact you to understand
            the property and what you need.
          </p>
          <div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          {isSubmitted ? (
            <div className={styles.success}>
              ...
              <p>
                Our team will review the property need and contact you using the
                details provided.
              </p>
            ...
            <>
              <div className={styles.formHead}>
                ...
                <p>Share the essentials. We will contact you to clarify the rest.</p>
              </div>
              ...
              <input
                ...
                value={form.botcheck}
                onChange={(e) =>
                  setForm((v) => ({ ...v, botcheck: e.target.value }))
                }
                tabIndex={-1}
                autoComplete="off"
                aria-hidden="true"
              ...
              <div className={styles.formGrid}>
                ...
                <label>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((v) => ({ ...v, propertyType: e.target.value }))
                    }
                  >
                ...
                <label>
                  ...
                  <select
                    value={form.helpWith}
                    onChange={(e) =>
                      setForm((v) => ({ ...v, helpWith: e.target.value }))
                    }
                  >
                    ...
                    <option>An urgent property issue</option>
              ...
              <label className={styles.message}>
                ...
                <textarea
                  ...
                  placeholder="Tell us what the property needs…"
                />
              </label>
