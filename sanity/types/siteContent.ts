...
export type DomicilePageContent = {
  ...
  explainedPhotoLabel?: string;
  explainedPhotoStatus?: string;
  explainedImage?: CmsImage;
  explanationSteps?: TitleText[];
  careTag?: string;
  careHeading?: string;
  careIntro?: string;
  carePrimaryImage?: CmsImage;
  careSecondaryImage?: CmsImage;
  careItems?: Array<{ label?: string; text?: string }>;
  ownerTag?: string;
  ownerHeading?: string;
  ownerIntro?: string;
  ownerImage?: CmsImage;
  ...
  properties?: Array<{ status?: string; title?: string; copy?: string; image?: CmsImage }>;
  trustTag?: string;
  trustHeading?: string;
  trustText?: string;
  faqTag?: string;
